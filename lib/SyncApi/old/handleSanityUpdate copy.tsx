...
//     this.sA = new SanityArtwork(sanityDocId, sanityClient)
//   }

//   init = async () => {
//     log('info', '____________________SanityUpdate')

//     await this.sA.getData()
...
//       this.shopifyProduct = await createProduct(
//         this.sanityArtwork,
//         this.sanityClient
//       )
//     }
...
//     this.sanityArtwork = await getSanityArtwork(
//       this.sanityDocId,
//       this.sanityClient
//     )
