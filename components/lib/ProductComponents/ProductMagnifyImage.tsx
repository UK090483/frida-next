...
const ProductMagnifyImage: React.FC<ProductMagnifyImageProps> = ({
  ...
  //       const rootRatio = rootClientRect.width / rootClientRect.height
  ...
  //   }
  // }, [imageRef.current, RootRef.current])
  ...
  return (
    ...
    >
      ...
      <div
        className={` w-40 h-40 absolute top-0 left-0 overflow-hidden rounded-full pointer-events-none border-frida-red border-4 transform -translate-x-20 -translate-y-20 transition-opacity transition-transform ${
